    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">ثبت مطلب جدید</li>
            </ol>
        </div>
    </div>
@stop
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ثبت مطلب</h3>
                </div>

                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">ثبت مطلب جدید</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{ route('admin.articles.create')}}" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="عنوان مطلب را وارد کنید" value="{{old('title')}}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">عنوان لاتین</label>
                                <input type="text" class="form-control" name="slug" placeholder="عنوان لاتین" value="{{old('slug')}}">
                            </div>
                            <div class="form-group">
